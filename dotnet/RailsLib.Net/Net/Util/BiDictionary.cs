...
// This code comes from https://github.com/Athari/Alba.Framework/blob/master/Alba.Framework/Collections/Collections/BiDictionary(TFirst,TSecond).cs
// The license is listed as public domain
...
namespace GameLib.Net.Util
{
    ...
    public class BiDictionary<TFirst, TSecond> : IDictionary<TFirst, TSecond>, IReadOnlyDictionary<TFirst, TSecond>, IDictionary
    {
        ...
        public BiDictionary(IDictionary<TFirst, TSecond> src) : this()
        {
        ...
        void ICollection<KeyValuePair<TFirst, TSecond>>.Add(KeyValuePair<TFirst, TSecond> item)
        {
            ...
            _secondToFirst.Add(new KeyValuePair<TSecond, TFirst>(item.Value, item.Key)); //item.Reverse());
        }
        ...
        public bool ContainsValue(TSecond key)
        {
        ...
        private class ReverseDictionary : IDictionary<TSecond, TFirst>, IReadOnlyDictionary<TSecond, TFirst>, IDictionary
        {
            ...
            void ICollection<KeyValuePair<TSecond, TFirst>>.Add(KeyValuePair<TSecond, TFirst> item)
            {
                ...
                _owner._firstToSecond.Add(new KeyValuePair<TFirst, TSecond>(item.Value, item.Key)); // item.Reverse());
            }
