/* $Header: /Users/blentz/rails_rcs/cvs/18xx/rails/ui/swing/hexmap/EWHexMap.java,v 1.6 2008/01/27 23:27:53 wakko666 Exp $*/
...
public class EWHexMap extends HexMap {
	...
	preferredSize = new Dimension((int) Math.round((hexArray.length + 1)
		* GUIHex.SQRT3 * scale), (int) Math
		.round((hexArray[0].length + 1) * 1.5 * scale));
    }
}
