...
public class StatusWindow extends JFrame implements ActionListener,
    ...
    /**
         * Selector for the pattern to be used in keeping the individual UI
         * fields up-to-date: <br> - true: push changes (via the
         * Observer/Observable pattern), <br> - false: pull everything on
         * repaint. NOTE: currently, 'false' does not work for the stock chart.
         */
