/* $Header: /Users/blentz/rails_rcs/cvs/18xx/rails/ui/swing/gamespecific/_18EU/StatusWindow_18EU.java,v 1.1 2008/03/05 19:55:13 evos Exp $*/
...
public class StatusWindow_18EU extends StatusWindow {
    ...
    protected boolean updateGameSpecificSettings () {
        ...
        if (currentRound instanceof FinalMinorExchangeRound) {
            setTitle(
                    LocalText.getText("FinalMinorExchangeRoundTitle"));
    ...
    public boolean processImmediateAction () {
        ...
        if (immediateAction != null) {
            ...
            if (nextAction instanceof DiscardTrain) {
                ...
                String discardedTrainName = (String) JOptionPane.showInputDialog (
                        this,
