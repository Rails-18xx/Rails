...
/**
 * A Station object represents any junction on a tile,
 * where one, two or more track fragments meet.
 ...
 * <p>
 * Station objects are used in Tile objects, to represent the station(s) on a tile.
 ...
 * <p>
 * See also the City class, which represents stations on tiles
 * that have actually been laid on a MapHex.
 *
 * @author Erik Vos
 */
public class Station
{
    ...
    protected static Logger log = Logger.getLogger(Station.class.getPackage().getName());
	...
	public Station(TileI tile, int number, String id,
			String type, int value, int slots, int position)
	{
	    this.tile = tile;
	    this.number = number;
		this.id = id;
	...
	public String getName() {
	    return "Station "+id+" on "+Util.getClassShortName(tile)+" "+tile.getName();
	}
	...
	{
		return "Station "+number+" on tile #"+tile.getId()+" ID: " + id + ", Type: " + type + ", Slots: "
