/* $Header: /Users/blentz/rails_rcs/cvs/18xx/rails/game/action/BuyStartItem.java,v 1.1 2008/02/13 20:02:07 evos Exp $
 * 
...
public class BuyStartItem extends StartItemAction {
    ...
    public BuyStartItem(StartItem startItem, 
    		int price, boolean selected, boolean setSharePriceOnly) {
	...
	public String toString() {
		...
		b.append ("BuyStartItem ").append(startItemName)
		 .append (" price=").append(price)
         .append (" selected=").append(selected);

		if (sharePriceToSet) {
		    b.append(" shareprice=").append(associatedSharePrice)
		     .append(" for company "+companyNeedingSharePrice);
		}
		return b.toString();
    }
