/* $Header: /Users/blentz/rails_rcs/cvs/18xx/rails/game/action/BuyOrBidStartItem.java,v 1.9 2008/02/28 21:43:49 evos Exp $
 * 
...
public class BuyOrBidStartItem extends PossibleAction {
    ...
    /** Selectable means that a player can select but not buy it.
     * In this case "Pass" means "Select but no buy".
     */
    ...
    public static final String[] typeNames
        = new String[] { "",
            "BuyImmediate", "SelectAndBuy", "BidImmediate",
            "SelectAndBid", "SelectAndBidOrPass",
            "SetSharePrice"
    };
    ...
    public BuyOrBidStartItem(StartItem startItem, 
    		int priceOrMinimumBid, int type) {
   ...
   /**
	...
	public String toString() {
		...
		b.append ("BuyOrBidStartItem ").append(startItemName)
		 .append (" type=").append(typeNames[type])
         .append (" status=");
        ...
        case StartItem.BIDDABLE:
			b.append(" minbid=").append(priceOrMinimumBid)
