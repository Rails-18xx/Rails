/* $Header: /Users/blentz/rails_rcs/cvs/18xx/rails/game/Attic/SpecialPropertyHolderI.java,v 1.2 2008/06/04 19:00:31 evos Exp $ */
package rails.game;
 ...
 * 
 * A SpecialPropertyHolder is any object that can own SpecialProperty objects.
 * Currently known cases: PrivateCompany and Portfolio. Portfolios hold
 * SpecialProperties that have been detached from the private that originally
 * held it, so that its lifetime is no longer dependent on that of the private.
 */
public interface SpecialPropertyHolderI {

    /**
     * Add a special property. Subclasses may override this method to implement
     * side effects.
     * 
