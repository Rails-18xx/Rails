...
public class ExchangeForCash extends PossibleAction {
    ...
    private ExchangeForCash(PrivateCompanyI company, int value, boolean ownerHasChoice) {
        this.ownerName = company.getPortfolio().getOwner().getName();
        this.value = value;
        this.ownerHasChoice = ownerHasChoice;
    }

    static public ExchangeForCash getAction(PrivateCompanyI company, TrainType soldOutTrainType) {
