     ...
     // Define a default stockspace type with colour white
        ...
        if (typeTags != null) {
            for (Tag typeTag : typeTags) {
                ...
                //Could be made even more Generic by using Revenue as Param and a numer as integer Attribute... 
                if(typeTag.getChild("Revenue5") != null)type.setAddRevenue(5);
                if(typeTag.getChild("Revenue10") != null)type.setAddRevenue(10);
                if(typeTag.getChild("Revenue15") != null)type.setAddRevenue(15);
                if(typeTag.getChild("Revenue20") != null)type.setAddRevenue(20);
                if(typeTag.getChild("Revenue40") != null)type.setAddRevenue(40);
