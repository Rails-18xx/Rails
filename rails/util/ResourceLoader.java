...
public final class ResourceLoader {
	...
	private static class RailsClassLoader extends ClassLoader {
		...
		protected static Logger log = Logger.getLogger(RailsClassLoader.class
				.getPackage().getName());
	...
	private static final ClassLoader baseCL = rails.util.ResourceLoader.class
			.getClassLoader();
	...
	protected static Logger log = Logger.getLogger(ResourceLoader.class
			.getPackage().getName());
	 ...
	 * @param cachedOnly
	 *            Only look in the cache file, do not try to load the file from
	 *            permanent storage.
	 * @param ignoreFail
	 ...
	 *            List of directories.
	 * @return A String to use as a key when storing/loading in a cache the
	 *         specified array of name of files from the specified list of
	 *         directories.
	 */
	 ...
	 * 
	 * @param className
	 *            The name of the class to use, must not be null.
	 * @param directories
	 *            List of directories to search (in order), must not be null.
	 * @param parameter
