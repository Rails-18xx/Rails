...
public class ComponentManager
{
   ...
   public static ComponentManager getInstance() throws ConfigurationException
   {
      ...
      throw new ConfigurationException(
            "ComponentManager has not yet been configured.");
   }
         ...
         Element element) throws ConfigurationException
   {
      ...
      {
         throw new ConfigurationException(
               "Cannot reconfigure the ComponentManager");
      }
         ...
         throws ConfigurationException
   {
      ...
      for (int i = 0; i < children.getLength(); i++)
      {
         ...
         try
         {
            ...
            component = (ConfigurableComponentI) compCons
         ...
         catch (Exception ex)
         {
            ...
            // could go wrong
            // here, and they all just mean that the configuration and code do
            // not combine
            // to make a well-formed system. Debugging aided by chaining the
            // caught exception.
            throw new ConfigurationException(
                  "Couldn't instantiate an object of class " + clazz
