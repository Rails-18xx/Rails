/* $Header: /Users/blentz/rails_rcs/cvs/18xx/game/Attic/StartPacket.java,v 1.6 2005/10/11 17:35:29 wakko666 Exp $
 * 
...
public class StartPacket
{
	...
	/**
	 * A Map holding all start packets of a game (yes, there can be more than
	 * one, e.g. 18US).
	 */
	...
	public void configureFromXML(Element element) throws ConfigurationException
	{
		...
		for (int i = 0; i < children.getLength(); i++)
		{
			...
			boolean president = XmlUtils.hasValue(XmlUtils.extractStringAttribute(nnp,
					"president",
					""));
			...
			if (children2.getLength() > 0)
			{
				...
				if (itemType2 == null)
					throw new ConfigurationException("No item type");
				boolean president2 = XmlUtils.hasValue(XmlUtils.extractStringAttribute(nnp2,
						"president",
						""));
