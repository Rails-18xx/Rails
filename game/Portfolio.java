/* $Header: /Users/blentz/rails_rcs/cvs/18xx/game/Attic/Portfolio.java,v 1.1 2005/04/16 22:51:22 evos Exp $
 * 
...
public class Portfolio {
	...
	/** Find any non-president certificate */
	public CertificateI findCertificate (PublicCompanyI company, boolean president) {
		String companyName = company.getName();
//System.out.println ("Looking for certificates of "+companyName+" in "+name);
...
//System.out.println(".. found "+cert.getCompany().getName()+" "+cert.getShare()+"%");
