 ...
 *
 */
public class ShareSellingRound_1844 extends ShareSellingRound {


    public ShareSellingRound_1844(GameManager parent, String id) {
        super(parent, id);
    }
     ...
     * TODO: Adjust to new Code from ShareSellingRound...
     */
    @Override
