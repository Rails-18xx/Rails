...
public class NetworkIterator_1880 extends 
    ...
    protected static Logger log =
            LoggerFactory.getLogger(NetworkIterator_1880.class.getPackage().getName());

    /**
     * Returns NetworkIterator for specific company
     */
    public NetworkIterator_1880(Graph<NetworkVertex, NetworkEdge> graph, NetworkVertex startVertex,
    ...
    private void addUnseenChildrenOf(NetworkVertex vertex, boolean greedy) {
        ...
        if ((vertex != startVertex) && ((vertex.getType() == NetworkVertex.VertexType.STATION))) {
            ...
            if (station.getType().equals(Station.Type.OFFMAPCITY)) {
                return;
            }
        }
