...
public abstract class Accessor2D<T extends Item, S extends Item> {
    ...
    public abstract static class AText<T extends Item, S extends Item> extends Accessor2D<T,S> {
    ...
    public abstract static class AObservable<T extends Item, S extends Item> extends Accessor2D<T,S> {
    ...
    public abstract static class AColors<T extends Item, S extends Item> extends Accessor2D<T,S> {
    ...
    public abstract static class AColorModel<T extends Item, S extends Item> extends Accessor2D<T,S> {
