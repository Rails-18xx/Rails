...
public abstract class Accessor1D<T extends Item> {
    ...
    public abstract static class AText<T extends Item> extends Accessor1D<T> {
    ...
    public abstract static class AObservable<T extends Item> extends Accessor1D<T> {
    ...
    public abstract static class AColors<T extends Item> extends Accessor1D<T> {
    ...
    public abstract static class AColorModel<T extends Item> extends Accessor1D<T> {
