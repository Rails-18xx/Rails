...
public final class RevenueAdapter implements Runnable {
    ...
    public RevenueAdapter(GameManager gameManager, NetworkAdapter networkAdapter, 
    ...
    public static RevenueAdapter createRevenueAdapter(GameManager gm, PublicCompany company, Phase phase) {
        NetworkAdapter networkAdapter = NetworkAdapter.create(gm);
        RevenueAdapter ra = new RevenueAdapter(gm, networkAdapter, company, phase);
    ...
    private void defineRevenueBonuses() {
        ...
        for (MapHex hex:hexes) {
            ...
            for (RevenueBonusTemplate bonus:bonuses) {
                addRevenueBonus(bonus.toRevenueBonus(hex, gameManager, graph));
            }
        }
