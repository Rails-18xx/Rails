...
public class ObjectMove extends Move {
    ...
    public boolean execute() {
        ...
        return (from == null || from.removeObject(moveableObject)) && to.addObject(moveableObject);
    }

    public boolean undo() {
        
        return to.removeObject(moveableObject) && (from == null ||from.addObject(moveableObject));
    }
    ...
    public String toString() {
        ...
        return "Move " + objectClassName + ": "
            + moveableObject.getName()
