...
/**
 * This class allows calculated values to be used as model objects
 * by using reflection. The value to be calculated is obtained
 * by calling a method specified by name. This method must return
 * an Integer and may not have any parameters.
 * @author Erik Vos
 *
 */
public class CalculatedMoneyModel extends ModelObject {
	...
	protected int calculate() {
		...
		try {
			...
			log.error("ERROR while invoking method "+methodName+" on class "+objectClass.getName(), e);
			return -1;
		}
