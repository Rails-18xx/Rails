/* $Header: /Users/blentz/rails_rcs/cvs/18xx/rails/game/special/SpecialTrainBuy.java,v 1.1 2007/12/30 14:25:13 evos Exp $ */
 ...
 * The deduction can be absolute (an amount) or relative (a percentage)
 * @author Erik Vos
 *
 */
public class SpecialTrainBuy extends SpecialProperty
{
	...
	public void configureFromXML(Tag tag) throws ConfigurationException
	{
		...
		if (!Util.hasValue(deductionString)) {
			throw new ConfigurationException ("No deduction found in <SpecialTrainBuy> tag");
		}
		...
		try {
			...
			throw new ConfigurationException ("Invalid deduction "+deductionString, e);
		}
	...
	public boolean isValidForTrainType (String trainType) {
		return trainTypeName.equals("") || trainTypeName.equalsIgnoreCase(trainType);
	}
	...
	public String toString() {
	    return "SpecialTrainBuy comp="+privateCompany.getName()+" extra="+extra+" deduction="+deductionString;
	}
