...
public class ConvertTilesXML
{
	...
	private ConvertTilesXML() throws ConfigurationException
	{
		...
		try
		{
			...
			TransformerFactory.newInstance()
					.newTransformer()
					.transform(new DOMSource(outputDoc),
			...
			throws ConfigurationException
	{
		...
		String id = inputTile.getElementsByTagName("ID")
				.item(0)
				.getFirstChild()
				.getNodeValue();
		...
		String level = inputTile.getElementsByTagName("level")
				.item(0)
				.getFirstChild()
				.getNodeValue();
		...
		String name = inputTile.getElementsByTagName("name")
				.item(0)
				.getFirstChild()
				.getNodeValue();
			...
			Element outputJunction) throws ConfigurationException
	{
		...
		String type = inputJunction.getElementsByTagName("junType")
				.item(0)
				.getFirstChild()
				.getNodeValue();
		...
		// Junction revenue
		Element revenue = (Element) inputJunction.getElementsByTagName("revenue")
				.item(0);
		if (revenue != null)
		{
			String value = revenue.getElementsByTagName("value")
					.item(0)
					.getFirstChild()
					.getNodeValue();
			...
			throws ConfigurationException
	{
		...
		String type = inputConnection.getElementsByTagName("conType")
				.item(0)
				.getFirstChild()
				.getNodeValue();
		...
		boolean fromOK = convertTrackEnd(inputConnection,
				outputConnection,
				"position1",
				"from");
		boolean toOK = convertTrackEnd(inputConnection,
				outputConnection,
				"position2",
				"to");
			...
			throws ConfigurationException
	{
		...
		String position = inputConnection.getElementsByTagName(inputName)
				.item(0)
				.getFirstChild()
				.getNodeValue();
