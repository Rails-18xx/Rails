/* $Header: /Users/blentz/rails_rcs/cvs/18xx/rails/ui/swing/hexmap/GUITile.java,v 1.5 2007/10/05 22:02:31 evos Exp $*/
...
public class GUITile {
    ...
    /**
         ...
         * 
         * @param initial:
         *                First rotation to try. Should be 0 for the initial
         *                tile drop, and 1 at subsequent rotation attempts.
         * @return <b>false</b> if no valid rotation exists (i.e. the tile
         *         cannot be laid).
         */
	...
	for (i = initial; i < 6; i++) {
		...
		if (tile.hasTracks(j - tempRot)) {
			...
			break;
		    /*
                         * If the previous tile has tracks against that side,
                         * but the new one has not, forbid this rotation (not
                         * preserving existing track).
                         */
		} else {
	...
	if (i == 6) {
	    /*
                 * If we have rotated six times, no valid rotation has been
                 * found.
                 */
	    return false;
	} else {
