...
public class ORPanel extends JPanel implements ActionListener, KeyListener {
    ...
    protected static Logger log = Logger.getLogger(ORPanel.class.getPackage()
	    .getName());
	...
	remainingTilesMenuItem = new JMenuItem(LocalText
		.getText("RemainingTiles"));
	...
	for (int i = 0; i < nc; i++) {
		...
		f = newPrivatesCost[i] = new Field(c
