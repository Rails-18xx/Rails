/* $Header: /Users/blentz/rails_rcs/cvs/18xx/rails/ui/swing/ORWindow.java,v 1.14 2008/01/27 23:27:54 wakko666 Exp $*/
...
public class ORWindow extends JFrame implements WindowListener, ActionPerformer {
    ...
    protected static Logger log = Logger.getLogger(ORWindow.class.getPackage()
	    .getName());
	...
	Class<? extends ORUIManager> orUIManagerClass = gameUIManager
		.getGameManager().getORUIManagerClass();
	try {
