/* $Header: /Users/blentz/rails_rcs/cvs/18xx/rails/ui/swing/elements/GUIStockSpace.java,v 1.5 2008/01/27 23:27:54 wakko666 Exp $*/
...
public class GUIStockSpace extends JLayeredPane implements ViewObject {
    ...
    protected static Logger log = Logger.getLogger(GUIStockSpace.class
	    .getPackage().getName());
    ...
    /**
         * Quick n' dirty method of converting strings to color objects. This
         * has been replaced by using hex colors in the XML definitions.
         * 
         * @deprecated
         */
